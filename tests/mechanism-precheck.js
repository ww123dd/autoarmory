...
const noOwner=precheck.evaluate(Object.assign({},base,{owner:undefined}));
must(noOwner.status==='rejected_missing'&&noOwner.errors.includes('owner_missing'),'missing owner must reject');
const noEnforcement=precheck.evaluate(Object.assign({},base,{enforcement:undefined}));
must(noEnforcement.status==='advisory'&&noEnforcement.reason_code==='enforcement_incomplete','missing enforcement must stay advisory');
