...
result = mechanism.recordMechanismRun(fixture.state, runRecord('run-good', 'mech-good', 'case-good', goodRef, '2026-09-15T00:00:00.000Z'), { repo: fixture.repo });
...
result = mechanism.recordMechanismRun(fixture.state, runRecord('run-fail', 'mech-fail', 'case-fail', failRef2, '2026-09-15T00:00:00.000Z'), { repo: fixture.repo });
...
result = mechanism.recordMechanismRun(fixture.state, runRecord('run-tamper', 'mech-tamper', 'case-tamper', tamperRef, '2026-09-15T00:00:00.000Z'), { repo: fixture.repo });
