...
must(report.candidate_id === 'case-1990aca9a628' && report.history_derived_run_count === 1 && report.run.status === 'closed' && report.run.result === 'pass', 'one true history-derived run must be closed and passing');
