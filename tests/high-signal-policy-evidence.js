...
must(report.metrics.candidate_case_draft_count === 530 && report.metrics.high_signal_notification_count === 0, 'candidate and high signal counts must be separated');
...
console.log('high signal policy evidence passed: 530 candidates -> 0 high signals');
