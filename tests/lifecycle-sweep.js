...
must(mechanism.registerMechanism(state,{schema_version:'autoarmory/mechanism/v1',id:'mech-sweep',name:'m',covered_failure_modes:['masked_failure'],trigger:'t',action:'a',verification:'v',verifier_id:'sweep-verifier',closure_criteria:'c',owner:'user',version:'1.0.0',scope:{project:'sweep',task_type:'fixture',environment:'test',artifact_type:'fixture'}},{repo:repo}).ok,'mechanism');
