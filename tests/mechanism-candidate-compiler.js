...
must(rows[0].verifier_id === 'verification-gap' && rows[0].enforcement.point === 'stop_hook' && rows[0].enforcement.mode === 'advisory', 'first mechanism must reference verifier and remain advisory until coverage is complete');
