...
const report = Object.assign({}, result, { budget: budgetPath, limits: escapes.limits, context_budget_escape_count: escapes.count, violations: escapes.violations });
if (args.json) printJson(report);
  ...
  process.stdout.write('  limits ' + JSON.stringify(escapes.limits) + '\n');
