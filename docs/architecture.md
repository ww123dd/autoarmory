...
Every transition record includes an actor. Approval transitions use approval.approved_by; other transitions use --actor or the default codex. This makes transition actors directly comparable with mechanism-run.actor.
