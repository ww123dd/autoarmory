...
function usage() {
  process.stdout.write([
    ...
    '  autoarmory intake artifact <descriptor.json> [--state <root>] [--repo .] [--json]',
    '  autoarmory bind artifact <artifact-id> --case <case-id> --verifier <verifier-id> [--case-file case.json] [--state <root>] [--repo .] [--json]',
    '  autoarmory run artifact <artifact-id> [--trials 3] [--state <root>] [--repo .] [--json]',
    '  autoarmory canary <command> [args]',
    '  autoarmory capability <register|list|health|outcome|drift|conformance> [--state <root>] [--json]',
    '  autoarmory transition <candidate.json> --to <pending_approval|gated|shadow|canary|promoted|rejected|retired> [--gate gate.json] [--approval approval.json] [--actor actor] [--evidence evidence.json] [--reason text] [--state <root>] [--dir project]',
    ...
    '  autoarmory scenario <list|show|plan|bench> [--state <root>] [--json]',
    '  autoarmory admit [candidates.jsonl] [--output admission.jsonl] [--json]',
    '  autoarmory integrate <list|import> [--state <root>] [--json]',
